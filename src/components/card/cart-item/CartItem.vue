    ...
    <div v-for="(j, jj) in prop.data.variant" v-if="prop.data.variant" :key="jj"
      ...
      <div class="flex items-start gap-3 h-full">
        ...
        <div class="w-[20%] h-full relative" if="media">
          <img :src="prop.data.image" alt="image of" class="w-full h-full relative object-cover">
        ...
        <div class="flex items-start gap-3 h-full w-full">
          ...
          <div class="w-[20%] h-full relative " >
            ...
            <div
                ...
                class="cursor-pointer absolute -top-2 -left-4 bg-custom-primary w-6 h-6 rounded-full text-white text-sm"
